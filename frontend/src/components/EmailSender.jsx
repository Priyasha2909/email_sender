...
function EmailSender() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      //after sending email, setting the fields to blank
      setEmailData({
        to: "",
        subject: "",
        message: "",
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="email_card md:w-1/2 w-full mx-4 md:mx-0 bg-white dark:bg-gray-700 dark:text-white dark:border-none m-4 p-4 rounded-lg border shadow">
        <h1 className="text-gray-900 dark:text-gray-200 text-3xl">
          Email Sender
        </h1>
        <p className="text-gray-700 dark:text-gray-300">
          Send email to your favourite person!!
        </p>
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className="form_field mt-4">
            ...
            <Editor
              ...
              apiKey="s78zvgazpkysy3xnhj797xllel4g0agae122msnyf5rv9wzy"
              init={{
                height: 200,
          ...
          <div className="button_container flex justify-center gap-2 mt-4">
            <button
              ...
              ${
                sending ? "cursor-not-allowed bg-blue-300" : "hover:bg-blue-900"
              }`}
            >
              Send Email
            </button>
            ...
            <button
              onClick={handleClear}
              className="hover:bg-gray-900 text-white bg-gray-600 px-3 py-2 rounded"
            >
              Clear
            </button>
          </div>
